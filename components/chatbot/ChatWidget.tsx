                ...
                {isOpen && (
                    ...
                    >
                        ...
                        <div className="px-2.5 sm:px-3 py-2 border-t flex items-center gap-2 shrink-0" style={{ backgroundColor: theme.backgroundColor, borderColor: theme.backgroundColor === '#ffffff' ? '#e5e7eb' : 'rgba(255,255,255,0.2)' }}>
                            <input value={input} onKeyDown={handleKeyDown} onChange={(e) => setInput(e.target.value)} className="flex-1 text-[11px] sm:text-xs bg-transparent outline-none" style={{ color: theme.textColor }} placeholder="Type a message..." />
